...
from rcl_interfaces.srv import DescribeParameters, GetParameters, GetParameterTypes, ListParameters, SetParameters, SetParametersAtomically
...
class ParameterService:
    ...
    def _list_parameters_callback(self, request, response):
        ...
        if not 0 == request.depth:
            ...
            names_with_prefixes = filter(names_with_prefixes,
                lambda name: name.count('.') + 1 <= request.depth)
